...
class CustomerControllerTest
{
    ...
    void testCreateCustomer() throws Exception
    {
        String testResult = mockMvc.perform(post("/api/customer/create")
                ...
                .content(objectMapper.setVisibility(PropertyAccessor.FIELD, JsonAutoDetect.Visibility.ANY).writeValueAsString(
                        Customer.builder()
                                .name("Harun Çınar")
                                .phoneNumber("05551122233")
        ...
        assertNotNull(createCustomerResponse.getCustomerDTO());
    }
}
